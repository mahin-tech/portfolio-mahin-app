...
const Index = () => {
  ...
  return (
    ...
    >
      <BasePage indexPage title="Portfolio - Mahin Prajapati">
            ...
            <Row>
              ...
              <Col md="6" className="hero-welcome-wrapper">
                <div className="hero-welcome-text">
                  <h1>
                    Welcome to the portfolio website of Mahin Prajapati.
                    Get informed, collaborate and discover projects I was working on through one year!
                  </h1>
                </div>
                <Typed
                  loop
